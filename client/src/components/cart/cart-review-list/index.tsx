        ...
        return (
            <div className="col-12 review-item-row" key={item.product.id}>
                <div className="flex align-items-center gap-3">
                    ...
                    <div className="text-right flex flex-column align-items-end" style={{ gap: '2px' }}>
                        {item.product.promo && item.product.discountType && item.product.discountValue !== undefined ? (
                            <>
                                <span className="text-xs line-through" style={{ color: '#888888' }}>
                                ...
                                <div className="text-xxs text-500 mt-0.5">
                                    {item.quantity}x {getEffectivePrice(item.product).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                                </div>
                            </>
                        ) : (
                            <>
