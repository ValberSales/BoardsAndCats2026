...
public class WebSecurity {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, PasswordEncoder passwordEncoder) throws Exception {
        ...
        http.authorizeHttpRequests((authorize) -> authorize
                ...
                // Leitura de catálogo (Produtos, Categorias, Imagens, Carousel, Media)
                .requestMatchers(HttpMethod.GET, "/products/**", "/categories/**", "/images/**", "/carousel/**", "/media/**").permitAll()

                // --- ROTAS ADMIN (Apenas Admin) ---
                .requestMatchers("/admin/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/products/**", "/categories/**", "/carousel/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/products/**", "/categories/**", "/carousel/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/products/**", "/categories/**", "/carousel/**").hasRole("ADMIN")
