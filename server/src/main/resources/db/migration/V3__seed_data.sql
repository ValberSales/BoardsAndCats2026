...
-- ########## USUÁRIOS ##########
INSERT INTO tb_user (id, username, display_name, password, phone, cpf, active, role) VALUES
(1, 'joao.silva@email.com', 'João Silva', '$2a$10$/cLFiA7e2tlMvcz/bcMKke0vBdcSwhUml7jogKP2MZiE1c/m1hc6i', '46999998888', '111.111.111-11', true, 'USER'),
(2, 'ana.souza@email.com', 'Ana Souza', '$2a$10$/cLFiA7e2tlMvcz/bcMKke0vBdcSwhUml7jogKP2MZiE1c/m1hc6i', '46988887777', '222.222.222-22', true, 'USER'),
(3, 'carlos.santos@email.com', 'Carlos Santos', '$2a$10$/cLFiA7e2tlMvcz/bcMKke0vBdcSwhUml7jogKP2MZiE1c/m1hc6i', '46977776666', '333.333.333-33', true, 'USER'),
(4, 'maria.lima@email.com', 'Maria Lima', '$2a$10$/cLFiA7e2tlMvcz/bcMKke0vBdcSwhUml7jogKP2MZiE1c/m1hc6i', '46966665555', '444.444.444-44', true, 'USER'),
(9, 'admin.cats@email.com', 'Admin Cats', '$2a$10$yQOIPaVLQS.R.ym1AU8bz.xw31kM9q3VQtJclt8EbjrjhHxbLvwxW', '46999999999', '000.000.000-00', true, 'ADMIN');
...
(20, 'The Mind', 'Mais que um jogo, uma experiência. Joguem cartas em ordem crescent (1-100) sem falar, sem sinais, sem comunicação. Apenas olhem nos olhos uns dos outros.', 49.90, false, 50, 'Cooperativo', '2-4', 'Pandasaurus', 2, '/images/jogos/mind_main.webp', '20 minutos', '8+'),
...
(21, '/images/acessorios/havenbox2.webp'), (21, '/images/havenbox3.png'),
...
(30, '/images/acessorios/dnd_shield_2.jpg'), (30, '/images/dnd_shield_3.jpg');
